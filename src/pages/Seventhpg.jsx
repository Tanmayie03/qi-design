...
const Seventhpg = () => {
  return (
    ...
    <p className="text-xl p-8 font-bold text-[#05668D] font-montserrat">Meet the Team</p>
    <p className="text-sm pr-[130px] text-justify tracking-[0px] pl-8 ">QI Ventures being founded by entrepreneurs has taken a step forward to appreciate and support the work of fellow founders, which is the best part. We are happy to have them as our investor and we share a very mutual respect for each other.	</p>
    ...
    <div className="flex justify-center w-full pt-24 text-center">
      <div className=" relative flex flex-col items-center  border p-9 border-[#02C39A]">
        ...
        <img src={linkedin} className="border w-6 p-1 absolute -bottom-3 bg-[#FEFFED] border-[#02C39A]" />
      </div>
      <div className=" relative flex flex-col items-center  border p-9 border-[#02C39A]">
      ...
      <div className=" relative flex flex-col items-center  border p-[38px] border-[#02C39A]">
        ...
        <p className="text-xs font-bold font-montserrat">Jayanth Balasubramanya</p>
        <p className="text-xs font-montserrat">Director & Partner</p>
        <img src={linkedin} className="border w-6 p-1 absolute -bottom-3 bg-[#FEFFED] border-[#02C39A]" />
    ...
    <div className='flex justify-center pt-8'>
            <button className='border border-[#00A896]  p-2  px-6 text-center text-[#00A896]  font-bold tracking-[6px] text-sm flex items-center'>MEET ENTIRE TEAM</button>
