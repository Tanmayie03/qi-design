...
function App() {
  ...
  return (
    ...
    <div className='bg-[#FEFFED] h-screen w-screen no-scrollbar  scrollbar-hide overflow-y-scroll
      flex justify-between items-center' id='scrollContainer'>
        <Border1 />
        <div className='flex flex-col gap-12  h-[545px] justify-between no-scrollbar scrollbar-hide overflow-y-scroll w-full
